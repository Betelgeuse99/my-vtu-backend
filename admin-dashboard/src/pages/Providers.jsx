          ...
          <button
            ...
            className={`flex-1 py-2.5 rounded-lg text-sm font-medium transition-all border ${
              current === p
                ...
                : 'bg-slate-700 text-slate-300 border-slate-600 hover:text-slate-100 hover:border-slate-500'
            }`}
          >
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Provider Routing</h1>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="card bg-slate-800 border-2 border-slate-700">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="flex items-center gap-3 flex-1">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-100">Master Global Switch</h2>
          ...
          <div>
            <h2 className="text-base font-bold text-slate-100 mb-3">Per-Service Overrides</h2>
